...
\subsection{Basic 2-DoF Synthesis using Regular Blending} \label{subsec:basic-synthesis}
...
\centering
    ...
    \begin{subfigure}[t]{0.45\textwidth}            
            \centering
            \includegraphics[width=\textwidth]{03/flow_seams01.jpg}
    ...
    \begin{subfigure}[t]{0.45\textwidth}
            \centering
            \includegraphics[width=\textwidth]{03/flow_seams02.jpg}
...
\centering
    ...
    \begin{subfigure}[t]{0.45\textwidth}            
            \centering
            \includegraphics[width=\textwidth]{03/flow_seams_ext16.jpg}
            \caption{Viewpoint A in extended cube map representation (150\degree FoV per face)}
    \end{subfigure}%
    \hfill
    \begin{subfigure}[t]{0.45\textwidth}
            \centering
            \includegraphics[width=\textwidth]{03/flow_seams_ext15.jpg}
