...
\subsection{Dynamic and Static Parameters}
...
%-optical flow ground truth is impossible to get from real scenes
%-however, virtual scenes contain all necessary information for retrieving ground truth for optical flow
%-virtual camera rig that captures one image per ``side'' with a fov that corresponds to that used in the ExtendedCubeMap \ar extended flow cube
