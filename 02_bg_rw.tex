...
Instead of trying to describe the scene through the objects it contains, IBR rendering techniques try to model the \emph{light rays} that reach the viewer.
...
\cite{raytracing} & \begin{tabular}[c]{@{}c@{}}360\degree\\ images\end{tabular} & 2 & \begin{tabular}[c]{@{}c@{}}none/\\ dense geo\end{tabular} & (\checkm) & \checkm & \cross & (\checkm) & \cross \\ \hline
...
\cite{cube2video} & \begin{tabular}[c]{@{}c@{}}360\degree\\ video\end{tabular} & 1 & \begin{tabular}[c]{@{}c@{}}sparse\\ feature\end{tabular} & (\checkm) & \checkm & \checkm & \checkm & \checkm \\ \hline
