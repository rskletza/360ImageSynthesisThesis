...
\todo{finish, and maybe mention other approaches, such as neural network approaches}
...
The overview of the presented approaches (Table~\ref{tab:comparison}) show that most approaches using \todo{explain table}
